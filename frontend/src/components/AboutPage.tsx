    ...
    <div className="bg-white">
      ...
      <div className="relative bg-brand-teal-600 text-white text-center py-24">
        ...
        <div className="relative z-10">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">About Fox</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              At Fox, our mission is to develop and provide high-quality, innovative orthopedic products that empower individuals to live healthier, more active lives. We believe that everyone deserves to move without pain and limitation.
            </p>
